...
const HeaderLeft = React.memo(() => {
  ...
  return (
    <div className="md:flex-[1]">
      <div className="min-h-screen top-0 hidden md:sticky md:flex items-center justify-center bg-teal-600 dark:bg-slate-600 text-white">
      ...
      {/* for mobile view */}
      <div className="fixed left-0 right-0 top-0 flex z-10 justify-evenly bg-teal-600 dark:bg-slate-600 p-3 text-white md:hidden">
